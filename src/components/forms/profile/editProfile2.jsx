    ...
    <div className='mt-3'>
      ...
      <div className="form-group mt-2">
        ...
        >
          ...
          <option value="materials" label="materials" />
          <option value="industrials" label="industrials" />
          <option value="health care" label="health care" />
          <option value="financials" label="financials" />
          <option value="information technology" label="information technology" />
          <option value="business services" label="business services" />
...
const editProfileSchema2 = yup.object().shape({
  country: yup.string().required('required'),
  category: yup.string().required('required'),
})

const FormsEditProfile2 = ({ onSubmit, profile }) => (
  <Formik
    initialValues={{
      country: profile?.country,
      category: profile?.category,
    }}
    validationSchema={editProfileSchema2}
    onSubmit={onSubmit}
    component={RenderForm}
  />
)
FormsEditProfile2.propTypes = {
  onSubmit: PropTypes.func.isRequired
}

export default FormsEditProfile2
